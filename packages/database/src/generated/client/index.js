...
path.join(
  process.cwd(),
  "packages/database/src/generated/client/libquery_engine-debian-openssl-3.0.x.so.node",
);
// file annotations for bundling tools to include these files
